const oilBrands = [
  ...
  { name: '', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlZSJZm5pnY-zUJ9gwh8G6-kGNEvpwrLtLy1FHGH0e3Lmxi7uH_rPp9ZpvTKxgNRyrnsaxaqDZ9rx0E22-Ud1eH41QDPQR&s&ec=121644704' },
  { name: '', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStk7-L4Eguwgd5T5v8tn__ZJGlB9uTj2mHfTO2VTcy4aRPzu2rrlE6yFc8zk1ix-mT2CmQNGhLQYGvibYVY28-AUFEvA4J&s&ec=121644704' },
  { name: '', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStJcpYmnVc4gLt-kT6ry9PQWvXB4ZZxwMND7DSeppxKQ7GN4aipBqIzkpbmPK-cMuwcorzOywMh05m8NsYTudHw2nQ3Dto&s&ec=121644704' },
  { name: '', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Motul_logo.svg/3840px-Motul_logo.svg.png' },
  { name: '', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVkKWpedQhyCW0iyMVRXIwfS9l251GgHOiZo9XnpaHIiuDKGJZFg6Yzrjqe9cvJmZSKxNjbmo3S5OSUoUZvZcoRR1h_54y&s&ec=121644704' },
  { name: '', logo: 'https://upload.wikimedia.org/wikipedia/commons/5/50/Liqui-moly.svg' },
];
    ...
    <section id="marcas" className="bg-secondary py-20 border-t-2 border-accent">
      <div className="container">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-9 gap-2 justify-items-center">
